\begin{textblock*}{3cm}(0cm,-1cm) % {block width} (coords)
    \begin{tikzpicture}
        \fill[ERDCRed] (0,0) rectangle (3,28.92); % Fill for the sidebar
        \draw[white, thick] (0.1,0.1) rectangle (2.9,28.929); % White border for aesthetic
    \end{tikzpicture}
\end{textblock*}
...
\begin{textblock*}{40cm}(1cm,10cm) % Adjust the width and position of the text block to accommodate larger text
    \rotatebox{90}{
        ...
        \textbf{\color{white}Bibliography} % Change text here
    }
\end{textblock*}
\newgeometry{left=5.81cm, top=1in, bmargin=1in, right=1in}
\begin{center}
\section{References \hspace{0.1cm} \color{white}4}
\end{center}
